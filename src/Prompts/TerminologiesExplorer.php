...
{
    /**
     * Guided workflow to discover and retrieve openEHR Terminology groups and codesets.
     *
        ...
        return [
            [
                ...
                'content' =>
                    ...
                    . 'Rules:' . "\n"
                    . '- Use available terminology resources; do not invent codes, rubrics, or terminology IDs.' . "\n"
                    ...
                    . '- When you to resolve a concept-rubric pair of a given terminology group, call the `terminology_resolve` tool. Groups are identified by their {openehr_id}.' . "\n\n"
                    . 'Workflow:' . "\n"
